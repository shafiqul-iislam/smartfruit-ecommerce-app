        ...
        <form @submit.prevent="placeOrder" class="space-y-4">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" v-model="checkout.name" class="w-full border rounded px-3 py-2 focus:ring focus:border-indigo-500" required />
            </div>
            <div>
              <label class="block mb-1 font-medium">Phone</label>
              <input type="tel" v-model="checkout.phone" class="w-full border rounded px-3 py-2 focus:ring focus:border-indigo-500" required />
            </div>
          </div>

          <div>
            <label class="block mb-1 font-medium">Email</label>
            <input type="email" v-model="checkout.email" class="w-full border rounded px-3 py-2 focus:ring focus:border-indigo-500" required />
          </div>

          <div>
            <label class="block mb-1 font-medium">Shipping Address</label>
            <textarea v-model="checkout.address" rows="3" class="w-full border rounded px-3 py-2 focus:ring focus:border-indigo-500" required></textarea>
          </div>
